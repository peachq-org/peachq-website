...
<div class="thanks-grid">
  ...
  <div class="card thanks-card thanks-card-wide"><h3>The wider q community</h3><p>Thanks to the people who have published q tutorials, examples, tools, documentation, tests, puzzles and libraries over the years. That includes past contributions from Charlie Skelton, Jo Shinonome, Stephen Taylor, András Dőtsch, Mark Street and many others, and ongoing work such as <a href="https://www.defconq.tech/" target="_blank" rel="noreferrer">DefconQ</a>. Some work is a direct input; much more is part of the shared foundation PeachQ learns from.</p></div>
</div>
</div></section>
</main>
<?php peachq_page_end(); ?>
