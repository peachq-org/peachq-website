...
function peachq_page_start(string $title, string $description = '', string $active = ''): void {
    ...
    $nav = [
        ...
        // /docs and /news are MkDocs output, so they need the trailing slash
        // that directory URLs use. They never match $active, since those pages
        // are generated by Material rather than rendered through this template.
        'docs' => ['Docs', '/docs/'],
        'news' => ['News', '/news/'],
        'about' => ['About', '/about'],
